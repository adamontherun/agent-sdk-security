...
(function () {
  ...
  // ---- analytics (PostHog) --------------------------------------------
  // Optional reader analytics via PostHog. Off by default: if these tokens are
  // left unresolved (or blank) the guard below is false and nothing loads — no
  // key, no network request. To enable, fill them at build/deploy time.
  // PH_KEY must be a *public* PostHog project token (phc_...) — safe to embed in
  // client-side pages. Never put a personal API key (phx_...) here.
  var PH_KEY = "phc_cXvb2Otk0GPp9scI79MUbhtT39gaeaBQu6muFZOVmoJ";
  var PH_HOST = "https://us.i.posthog.com";
  var COURSE = "agent-sdk-security";
